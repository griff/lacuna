...
$rcmail_config['temp_dir'] = '/var/tmp/roundcube/';
...
$rcmail_config['des_key'] = 'j901F-5H?$MwU61vyEIUk_o+';
...
// %z - IMAP domain (IMAP hostname without the first part)
// For example %n = mail.domain.tld, %d = domain.tld
$rcmail_config['mail_domain'] = 'vagtelhave.dk';
...
$rcmail_config['product_name'] = 'Vagtelhave Webmail';
