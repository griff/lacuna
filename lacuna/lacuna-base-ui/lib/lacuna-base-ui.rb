if defined?(Merb::Plugins)
  ...
  Merb::Plugins.add_rakefiles "lacuna-base-ui/merbtasks", "lacuna-base-ui/slicetasks", "lacuna-base-ui/spectasks"
  ...
  # :layout - the layout to use; defaults to :lacuna-base-ui
  # :mirror - which path component types to use on copy operations; defaults to all
  Merb::Slices::config[:lacuna_base_ui][:layout] ||= :lacuna_base_ui
  ...
  module Lacuna::BaseUi
    ...
    #
    # @note prefix your named routes with :lacuna_base_ui_
    #   to avoid potential conflicts with global named routes.
    def self.setup_router(scope)
      # example of a named route
      scope.match('/index(.:format)').to(:controller => 'main', :action => 'index').name(:index)
      # the slice is mounted at /lacuna-base-ui - note that it comes before default_routes
  ...
  # Add dependencies for other LacunaBaseUi classes below. Example:
  # dependency "lacuna-base-ui/other"
